package com.example.leiyu.myshortvideo.camera;
...
import com.example.leiyu.myshortvideo.camera.blacklist.BlackListHelper;
...
public class CameraUtils {
    ...
    public static void setPreviewFps(Camera camera, int fps, Camera.Parameters parameters) {
        ...
        if(BlackListHelper.deviceInFpsBlacklisted()) {
            Log.d("CameraUtils", "Device in fps setting black list, so set the camera fps 15");
            fps = 15;
        }
        try {
    ...
    public static void setPreviewSize(Camera camera, CameraData cameraData, int width, int height,
        ...
        //设置预览大小
        Log.d("CameraUtils", "Camera Width: " + size.width + "    Height: " + size.height);
        try {
